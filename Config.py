...
class Config:
    MainDir = os.path.dirname(sys.executable) if getattr(sys, 'frozen', False) else os.path.dirname(os.path.realpath(os.path.abspath(__file__)))
    ...
    def load_from_file(cls, file_path):
        ...
        if map:
            ...
            if changed:
                cls.W_WIDTH, cls.W_HEIGHT = cls.GRID_COLS * cls.SideLength, (cls.GRID_ROWS * cls.SideLength) + cls.StatusBarHeight  # Window width, height
